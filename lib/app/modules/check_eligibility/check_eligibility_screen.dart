...
class CheckEligibilityPage extends StatefulWidget {
  ...
  @override
  State<CheckEligibilityPage> createState() => _CheckEligibilityPageState();
}

class _CheckEligibilityPageState extends State<CheckEligibilityPage>
          ...
          child: Column(
            ...
            children: [
                        ...
                        children: [
                          ...
                          AnimatedBuilder(
                            ...
                            builder: (context, child) {
                              final double t = _circleAnimation.value;
                              return SizedBox(
                                width: 92,
                                height: 78,
                                child: Stack(
              ...
              _ReasonCard(
                ...
                subtitle:
                    'Get feedback on your application within minutes, not days.',
              ),
              _ReasonCard(
                number: 2,
                title: 'No Collateral',
                subtitle:
                    'Access credit without putting your assets at risk. High trust, low friction.',
              ),
              _ReasonCard(
                number: 3,
                title: 'Flexible Terms',
                subtitle:
                    'Repayment schedules that align with your unique monthly cash flow.',
              ),
